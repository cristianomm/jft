...
public class Logging implements ILog {
    ...
    /* (non-Javadoc)
     * @see com.cmm.logging.ILog#log(java.lang.Class, java.lang.String, java.lang.Throwable, org.apache.log4j.Level)
     */
    @Override
    public void log(Class<?> cls, String message, Throwable throww, Level level) {
	printStackTrace(throww);
