 ...
 * 
 * <p>
 * <code>TradePosition</code>
 * </p>
 * 
 * @author Cristiano M Martins
 * @version Aug 6, 2013 2:00:40 AM
 */
public class TradePosition implements DBObject<TradePosition> {

	private long tradePositionId;
	 ...
	 * @param symbol
	 */
	public TradePosition(String symbol) {
		this.open = false;
		this.symbol = symbol;
	...
	public String toString() {
		final int maxLen = 10;
		return "TradePosition [positionSerial=" + this.positionSerial + ", ordersSet="
