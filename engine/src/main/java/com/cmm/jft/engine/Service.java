...
public class Service {
	...
	private void init() throws ConfigError, FieldConvertError, JMException {
		...
		acceptor = new SocketAcceptor(streamApplication, messageStoreFactory, streamApplication.getSessionSettings(),
				logFactory, messageFactory);

		configureDynamicSessions(streamApplication.getSessionSettings(), streamApplication, messageStoreFactory,
				logFactory, messageFactory);
